...
/*******************************************************************
		...
		1. 1 channel conversion (in this case AN5)
		2. PWM trigger starts conversion
		3. Pot is connected to CH0 and AN5
...
void InitADC10(void)
{
 	AD1PCFGLbits.PCFG0 = 0;         // ensure AN0/RB0 pot)
...
void InitIC(void)
{
	...
	TRISB |= 0x1E0;		// Ensure that hall connections are inputs 
