...
long DutyCycle = 0;
unsigned int Kps = 10000; /*20000*/  // Kp and Ks terms need to be adjusted
unsigned int Kis = 1000;   /*2000*/   // as per the motor and load 
...
void __attribute__((interrupt, no_auto_psv)) _IC1Interrupt (void)
{
	...
	HallValue = (unsigned int)((PORTB >> 5) & 0x0007);	// Read halls
	
	//LATA &= 0xfff8;			// Send hall value to LED's
	//LATA |= HallValue;	
...
Function:		void __attribute__((interrupt, no_auto_psv)) _IC3Interrupt (void)
